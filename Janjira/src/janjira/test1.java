...
public class test1 extends javax.swing.JFrame {
    ...
    public test1() {
        initComponents();
        setTitle("Janjira Autama s5050232@kmitl.ac.th - Java Web Browser (Network Programming Class Assignment)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        public void run(){  
            ...
            try
            {
                ...
                try {                    
                    URL web;
                    web = new URL(jTextField1.getText());
       ...
       Thread thread2; 
        ...
        public void run(){
            ...
            try
            {
                ...
                try {
                    URL web = new URL(jTextField2.getText());
                    URLConnection conn = web.openConnection();
                    Map<String, List<String>> map = conn.getHeaderFields();
